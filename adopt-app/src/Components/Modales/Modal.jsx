...
export const Modal = ({ children, isOpen, closeModal, selectPetName }) => {
    if (!isOpen) {
        return null;
    }
    ...
    return ReactDOM.createPortal(
        <div className={`modal ${isOpen && `is-open`} modal-overlay`} onClick={closeModal}>
            <div className='modal-container' onClick={handLeClick}>
                <button className='modal-close-btn' onClick={closeModal}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="modal-close-btn" viewBox="0 0 16 16">
