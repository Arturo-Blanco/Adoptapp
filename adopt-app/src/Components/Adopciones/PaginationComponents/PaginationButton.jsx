...
const PaginationButton = (props) => {
    const { className, id, value, onClick, text } = props

    const previousBtn = <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="previous-pag-btn" viewBox="0 0 16 16">
    ...
    const nextBtn = <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="next-pag-btn" viewBox="0 0 16 16">
